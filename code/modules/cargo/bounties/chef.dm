/datum/bounty/item/chef/birthday_cake
	name = "Birthday Cake"
	description = "Commander Irene's birthday is coming up! Ship them a birthday cake to celebrate!"
	reward = 1000
...
/datum/bounty/item/chef/chawanmushi
	name = "Chawanmushi"
	description = "Nanotrasen wants to improve relations with its sister company, Donk.Co. Ship Chawanmushi immediately."
	reward = 5000
