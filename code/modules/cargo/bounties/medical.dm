...
/datum/bounty/item/medical/blood
	name = "Generic Blood"
	description = "The Nanotrasen annual blood drive is back up to full speed, following the garlic incident. Good blood in good volumes accepted for Credit returns."
	reward = 3500
	required_count = 600
