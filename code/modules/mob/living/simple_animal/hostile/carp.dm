...
/mob/living/simple_animal/hostile/carp/cayenne/lia
	name = "Lia"
	real_name = "Lia"
	desc = "A failed experiment of Nanotrasen to create weaponised carp technology, now acquired by Nanotrasen. This less than intimidating carp now serves as the Head of Security's pet."
