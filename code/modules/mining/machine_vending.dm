...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list( //if you add something to this, please, for the love of god, sort it by price/type. use tabs and not spaces.
		...
		new /datum/data/mining_equipment("Basic Shelter Capsule",		/obj/item/survivalcapsule,											400),
		...
		new /datum/data/mining_equipment("Advanced Shelter Capsule",	/obj/item/survivalcapsule/advanced,									1500),
		...
		new /datum/data/mining_equipment("Nanotrasen",					/mob/living/simple_animal/hostile/mining_drone,						800),
...
/obj/machinery/mineral/equipment_vendor/ui_interact(mob/user)
	...
	var/list/dat = list()
	dat += "You have [I.mining_points] mining points collected."
