...
/obj/structure/showcase/mecha/marauder
	...
	desc = "A stand with an empty old Nanotrasen combat mech bolted to it. It is described as the premier unit used to defend corporate interests and employees."
...
/obj/structure/showcase/machinery/microwave
	...
	desc = "The famous Nanotrasen microwave, the multi-purpose cooking appliance every station needs! This one appears to be drawn onto a cardboard box."
...
/obj/structure/showcase/machinery/tv
	name = "Nanotrasen brand newsfeed"
